...
class RightModel(Basebase):
    pass
class KvmModel(Basebase):
    pass
class ProjectModel(Basebase):
    pass
...
class RoutingSession(Session):
    def get_bind(self, mapper=None, clause=None):
        if mapper and issubclass(mapper.class_, RightModel):
            return engines['right']
        elif mapper and issubclass(mapper.class_, KvmModel):
            return engines['kvm']
        elif mapper and issubclass(mapper.class_, ProjectModel):
