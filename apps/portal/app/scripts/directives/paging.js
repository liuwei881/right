define(['angular'], function (angular) {
    ...
    /**
     * @ngdoc directive
     * @name portalApp.directive:paging
     * @description
     * # paging
     */
    angular.module('portalApp.directives.Paging', [])
        .directive('paging', function () {
            ...
            return {
                ...
                template: '<div class="row" style="margin:-20px -15px;"><div class="col-md-12 col-sm-12"><div class="dataTables_paginate paging_simple_numbers" style="text-align: right;">' +
